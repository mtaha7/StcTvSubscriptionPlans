package com.stc.tv.automation.utils;
...
public class Log {
    ...
    static boolean  addLogToExtentReportFlag = (generalConfigsProps.getProperty(GeneralConstants.ADD_LOG_TO_EXTENT_REPORT).toLowerCase().equals(GeneralConstants.TRUE.toLowerCase())? true : false);



// Initialize Log4j logs

        private static Logger Log = LogManager.getLogger(com.stc.tv.automation.utils.Log.class.getName());//
